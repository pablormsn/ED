...
public class SparseVectorTesting {
    ...
    public static void main(String[] args) {
        ...
        check(vector1.size() == VECTOR_SIZE, "dataStructures.vector has wrong size");
        check(new SparseVector<>(0, 1).size() == 1, "dataStructures.vector has wrong size");
        ...
        // build a dataStructures.vector with all elements equal and set one element to a
        // different value
        {
            for (int i = 0; i < VECTOR_SIZE; i++) {
                SparseVector<Character> v = new SparseVector<>(N, INITIAL_ELEM);
                v.set(i, 'b');
                check(VECTOR_SIZE == v.size(), "dataStructures.vector has wrong size");
        ...
        // build a dataStructures.vector with all elements equal and then set one element to
        ...
        // Iterate Over Vector Returns Its Contents()
        {
            ...
            check(message.length() == v.size(), "dataStructures.vector has wrong size");
