...
import dataStructures.vector.SparseVector.Node;
import dataStructures.vector.SparseVector.Tree;
import dataStructures.vector.SparseVector.Unif;
...
public class SparseVectorTesting {
     ...
     *
     * @param condition an assertion expected to be true
